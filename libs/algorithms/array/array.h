...
// в отсортированном массиве a размера n при его наличии, иначе - возвращает n.
size_t binarySearch_(const int *a, const size_t n, const int x);

size_t binarySearchOrderedSet_(const int *a, const size_t n, const int x);
...
size_t binarySearchMoreOrEqual_(const int *a, const size_t n, const int x);
...
// выполняет сортировку вставками массива a размера n
