...
// end не включая end, если символ не найден, возвращает
// значение end.
...
// нуль-символом, если символ не найден, возвращает адрес первого
// нуль-символа.
...
// если символ не найден, возвращает адрес первого нуль-символа.
...
// лексикографическом порядке; значение 0, если lhs и rhs равны; положительное
// значение, если lhs распологается после rhs в лексикографическом порядке.
...
// лексикографическом порядке; значение 0, если w1 и w2 равны; положительное
// значение, если w1 распологается после w2 в лексикографическом порядке.
int wordcmp_(wordDescriptor w1, wordDescriptor w2);

// возвращает значение 1, если слова w1 и w2 идентичны, в
...
// возвращает значение 1, если массивы слов bag1 и bag2 равны,
