...
// возвращает значение позицию элемента в множестве, если
// значение value имеется в множестве set, иначе - n.
size_t ordered_array_set_in(const ordered_array_set *set,
                            int value);

// возвращает значение ’истина’, если элементы множеств
// set1 и set2 равны, иначе - ’ложь’.
bool ordered_array_set_isEqual(ordered_array_set set1,
                               ordered_array_set set2);

// возвращает значение ’истина’, если subset является
// подмножеством set, иначе - ’ложь’.
